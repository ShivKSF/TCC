						...
						<div class="col-md-4 col-sm-12">
							<div class="mb-3">
								...
								<select class="form-select" aria-label="Default select example" name="<?php echo $campo8 ?>" id="<?php echo $campo8 ?>">
									...
									<?php
									$query = $pdo->query("SELECT * FROM planopagamento ORDER BY id ASC");
									$res = $query->fetchAll(PDO::FETCH_ASSOC);
									for ($i = 0; $i < @count($res); $i++) {
										foreach ($res[$i] as $key => $value) {
										}
										$id_item = $res[$i]['id'];
										$descricao_item = $res[$i]['descricao'];
									?>
										<option value="<?php echo $descricao_item ?>"><?php echo $descricao_item ?></option>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<small>
					...
					<span><b>Data de Emissão:</b> <span id="campo6"></span></span>
					<span class="mx-4"><b>Data de Vencimento:</b> <span id="campo7"></span>
					</span>
					<hr style="margin:6px;">
					...
					<span><b>Usuário Fechamento:</b> <span id="campo11"></span></span>
					<hr style="margin:6px;">

					<span><b>Status Conta:</b> <span id="campo13"></span></span>
					<span class="mx-4"><b>Data Fechamento:</b> <span id="campo18"></span>
					</span>
					<hr style="margin:6px;">
