...
if($id == ""){
	...
	$query = $pdo->prepare("INSERT INTO $pagina set descricao = :campo1, dataEmissao = :campo6, dataVencimento = :campo7, planoPagamento = :campo8, valor = :campo9, usuario_lancamento = :campo10, status = 'Pendente', data_recor = curDate(), arquivo = '$imagem'");
	...
	$query = $pdo->prepare("UPDATE $pagina set descricao = :campo1, saida = :campo3, documento = :campo4, plano_conta = :campo5, data_emissao = :campo6, vencimento = :campo7, frequencia = :campo8, valor = :campo9, usuario_lancamento = :campo10, arquivo = '$imagem' WHERE id = '$id'");
