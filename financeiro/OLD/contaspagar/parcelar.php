...
for($i=1; $i <= $qtd_parcelas; $i++){
	...
	$pdo->query("INSERT INTO $pagina set descricao = '$nova_descricao', dataEmissao = curDate(), vencimento = '$novo_vencimento', frequencia = '$cp8', valor = '$novo_valor', id_usuario_lancamento = '$cp10', status = 'Pendente', dataRecorrencia = curDate()");
