						...
						<div class="tab-pane fade show active" id="dados" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="row">
								...
								<div class="col-md-1 col-sm-12">
									<div class="mb-3">
										...
										<input type="text" maxlength="2" class="form-control" name="<?php echo $campo8 ?>" placeholder="<?php echo $campo8 ?>" id="<?php echo $campo8 ?>">
									</div>
								</div>
								...
								<div class="col-md-2 col-sm-12">
									<div class="mb-3">
										...
										<input type="text" maxlength="11" class="form-control" name="<?php echo $campo13 ?>" placeholder="Telefone/Celular" id="<?php echo $campo13 ?>">
									</div>
								</div>
								...
								<div class="col-md-3 col-sm-12">
									<div class="mb-3">
										...
										<input type="text" maxlength="11" class="form-control" name="<?php echo $campo17 ?>" placeholder="Para cobrança via WhatsApp" id="<?php echo $campo17 ?>">
									</div>
								</div>
							...
							<div class="row">
								<div class="mb-3">
									...
									<textarea maxlength="100" class="form-control" name="<?php echo $campo18 ?>" id="<?php echo $campo18 ?>" placeholder="Histórico do Atleta"></textarea>
								</div>
							</div>
