...
//VARIAVEL COM O NOME DA PAGINA/PASTA/ARQUIVO
$pagina = 'alunos';

//CHAMA VARIAVEIS NO ARQUIVO CAMPOS
...
<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Cadastrar Atleta</a>
</div>
							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-12">
									<div class="mb-3">
										...
										<input type="text" maxlength="11" minlength="11" class="form-control" name="<?php echo $campo3 ?>" id="<?php echo $campo3 ?>">
									</div>
								</div>
								...
								<div class="col-md-2 col-sm-12">
									<div class="mb-3">
										...
										<input type="number" maxlength="8" minlength="8"class="form-control" name="<?php echo $campo11 ?>" id="<?php echo $campo11 ?>" placeholder="<?php echo $campo11 ?>">
									</div>
								</div>
								...
								<div class="col-md-1 col-sm-12">
									<div class="mb-3">
										...
										<input maxlength="2" minlength="2" type="text" class="form-control" name="<?php echo $campo8 ?>" placeholder="<?php echo $campo8 ?>" id="<?php echo $campo8 ?>">
									</div>
								</div>
								...
								<div class="col-md-2 col-sm-12">
									<div class="mb-3">
										...
										<input type="text" maxlength="8" class="form-control" name="<?php echo $campo10 ?>" placeholder="<?php echo $campo10 ?>" id="<?php echo $campo10 ?>">
									</div>
								</div>
								...
								<div class="col-md-2 col-sm-12">
									<div class="mb-3">
										...
										<input type="text" minlength="9" maxlength="14" class="form-control" name="<?php echo $campo13 ?>" placeholder="Telefone/Celular" id="<?php echo $campo13 ?>">
									</div>
								</div>
