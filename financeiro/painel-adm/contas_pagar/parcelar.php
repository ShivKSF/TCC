...
for($i=1; $i <= $qtd_parcelas; $i++){
	...
	$pdo->query("INSERT INTO $pagina SET descricao = '$nova_descricao', plano_conta = '$cp5', data_emissao = curDate(), vencimento = '$novo_vencimento', frequencia = '$cp8', valor = '$novo_valor', usuario_lanc = '$cp10', status = 'Pendente', data_recor = curDate()");

}

$pdo->query("UPDATE $pagina SET status = '$nova_descricao/$qtd_parcelas' WHERE id = '$id'");
