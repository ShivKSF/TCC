...
for($i=1; $i <= $qtd_parcelas; $i++){
	...
	$pdo->query("INSERT INTO $pagina set descricao = '$nova_descricao', id_aluno = '$cp2', id_patrocinador = '$cp4', data_emissao = curDate(), vencimento = '$novo_vencimento', frequencia = '$cp8', valor = '$novo_valor', usuario_lanc = '$cp10', status = 'Pendente', data_recor = curDate()");
