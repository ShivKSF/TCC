							...
							<div class="row">
								...
								<div class="col-md-2 col-sm-12">
									<div class="mb-3">
										...
										<input type="tel" minlength="9" maxlength="14" class="form-control" name="<?php echo $campo13 ?>" placeholder="Telefone/Celular" id="<?php echo $campo13 ?>">
									</div>
								</div>
								...
								<div class="col-md-2 col-sm-12">
									<div class="mb-3">
										...
										<input type="tel" minlength="9" maxlength="14" class="form-control" name="<?php echo $campo14 ?>" placeholder="Telefone/Celular" id="<?php echo $campo14 ?>">
									</div>
								</div>
								...
								<div class="col-md-3 col-sm-12">
									<div class="mb-3">
										...
										<input type="email" class="form-control" name="<?php echo $campo15 ?>" placeholder="Para cobrança automática" id="<?php echo $campo15 ?>">
									</div>
								</div>
								...
								<div class="col-md-3 col-sm-12">
									<div class="mb-3">
										...
										<input type="tel" minlength="9" maxlength="14" class="form-control" name="<?php echo $campo17 ?>" placeholder="Para cobrança via WhatsApp" id="<?php echo $campo17 ?>">
									</div>
								</div>
